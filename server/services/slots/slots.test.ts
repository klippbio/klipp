...
import { MINUTES_DAY_END, MINUTES_DAY_START } from "../calendar/availablity";
...
beforeAll(() => {
  ...
  dateRangesMockDay = [
    { start: dayjs.utc().startOf("day"), end: dayjs.utc().endOf("day") },
  ];
...
describe("Tests the slot logic", () => {
      ...
      dateRanges: [
        {
          ...
          end: dayjs("2021-06-21T23:45:00.000Z"),
        },
      ],
      /*workingHours: [
        {
  ...
  it("tests the final slot of the day is include", async () => {
    const slots = getSlots({
      inviteeDate: dayjs.tz("2023-07-13T00:00:00.000+02:00", "Europe/London"),
      eventLength: 15,
      workingHours: [
        {
          days: [1, 2, 3, 4, 5],
      ...
      dateRanges: [
        {
          start: dayjs("2023-07-13T07:00:00.000Z"),
          end: dayjs("2023-07-13T15:00:00.000Z"),
        },
        {
          start: dayjs("2023-07-13T18:30:00.000Z"),
          end: dayjs("2023-07-13T20:59:59.000Z"),
        },
      ],
    ...
    expect(slots[0].time.format()).toBe("2023-07-13T21:45:00+01:00");
  });
  ...
  it("new test", async () => {
    const slots = getSlots({
      inviteeDate: dayjs.tz("2023-12-05T00:00:00.000+05:30", "Asia/Kolkata"),
      frequency: 15,
      minimumBookingNotice: 0,
      eventLength: 15,
      organizerTimeZone: "America/Toronto",
      dateRanges: [
        {
          start: dayjs.tz("2023-12-05T09:00:00.000", "America/Toronto"),
          end: dayjs.tz("2023-12-05T17:00:00.000", "America/Toronto"),
        },
      ],
    });
    slots.map((slot) => console.log(slot.time.toISOString()));
    // expect(slots[0].time.format()).toBe("2023-07-13T08:00:00+05:30");
    expect(slots);
  });
});
