...
export default function Footer() {
  const navigation = ["Product", "Features", "Pricing", "Earnings Calculator"];
  return (
    <div className="relative bg-secondary">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-2 gap-10 mx-auto border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div>
              ...
              >
                <Image src={LogoText} alt="Klipp" width="150" />
              </Link>
            </div>
